...
class Settings:
    ...
    def __init__(self):
        ...
        self.info_survey_url = <FORMS URL>

        # Set google sheets id's
        # todo move credentials and alter filepath
        self.google_creds = <GOOGLE CREDS PATH>
        self.info_session_tracker = <URL>
        self.info_session_registration = <URL>
        self.fy22_training_attendance = <URL>
        self.fy23_training_attendance = <URL>
        ...
        self.data_management_path = <ONE DRIVE DATA MANAGMENT PATH
        ...
        self.accepted_grants = ['CDBG', 'DOL Opioid', 'EARN', 'Grads2Careers', 'MOED Opioid','OWIF', 'OWIF-W', 'SNAP',
                                'WIOA']
        # todo alter filepath
        with open(<GRANT CYCLES JSON PATH>, 'r') as file:
        ...
        with open(<TU ACTIVITY INDEX>, 'r') as file:
